...
<ul id="message-recipients-nav" class="message-recipients-nav side-nav">
    @foreach($salesPeople as $salesPerson)
        <li><a id="{{$salesPerson->id}}" href="#"
               class="message-recipients-nav-person message-recipient-click">
...
<div class="fixed-action-btn">
    <a href="#" class="btn-floating btn-large amber darken-3 button-collapse-messages"
       data-activates="message-recipients-nav">
